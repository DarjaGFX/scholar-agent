...
from scholar_agent.tools import FIND_SCHOLARS, find_scholars
...
TOOL_REGISTRY = {"find_scholars": find_scholars}
TOOL_SCHEMAS = [FIND_SCHOLARS]
...
async def run_agent(query: str, client, max_steps: int = 5) -> str:
    messages = [
